  ...
  return (
    ...
    >
      ...
      <span className="flex flex-col leading-[1.1]">
        ...
        <span className="font-sans text-[8.5px] font-semibold uppercase tracking-[2.8px] text-[#C9A24A]">
...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-[1000] border-b border-gold/20 bg-[rgba(9,12,11,0.94)] backdrop-blur-md">
      <div className="mx-auto flex h-[78px] max-w-[1280px] items-center justify-between gap-6 px-8">
        <Logo />
        ...
        {open && (
          <>
            <motion.div
              ...
              className="fixed inset-0 top-[78px] z-[998] bg-black/55"
            />
            <motion.div
              initial={{ x: "-100%" }}
              animate={{ x: 0 }}
              ...
              className="fixed bottom-0 left-0 top-0 z-[999] flex w-[78%] max-w-[320px] flex-col gap-1.5 border-r border-gold/20 bg-[#0A0D0C] p-6 shadow-[8px_0_32px_rgba(0,0,0,0.5)]"
            >
              <div className="mb-5 flex items-center gap-3">
                ...
                <button
                  ...
                  className="ml-auto h-9 w-9 rounded-lg border-none bg-gold/15 text-[20px] text-gold"
                >
                  ×
                </button>
              </div>
