...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-[26px] right-[26px] z-[900] flex h-[60px] w-[60px] items-center justify-center rounded-full bg-green no-underline transition-colors hover:bg-green-dark"
