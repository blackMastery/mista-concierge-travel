...
('values', '[{"icon":"✦","title":"Excellence","body":"We sweat the smallest details so you never have to think about them."},{"icon":"❖","title":"Authenticity","body":"Real islands, real people — never a manufactured experience."},{"icon":"🌿","title":"Sustainability","body":"We travel lightly and reinvest in the communities that host us."},{"icon":"✎","title":"Personalization","body":"Every journey is shaped entirely around you."}]'),
